                            ...
                            child: FlutterFlowChoiceChips(
                              options: [
                                ChipData(FFLocalizations.of(context).getText(
                                  'aly2ltql' /* 12 months payment */,
                                )),
                                ChipData(FFLocalizations.of(context).getText(
                                  'ilvln635' /* 6 months payment */,
                                )),
                                ChipData(FFLocalizations.of(context).getText(
                                  '1p213o3g' /* 3 months payment */,
                                ))
                              ],
